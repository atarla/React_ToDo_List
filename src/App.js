...
class App extends Component {
  ...
  getTasks(){
      axios.request({
          method:'get',
          url:'https://api.mlab.com/api/1/databases/reacttasksapp/collections/tasks?apiKey=hGZCvC3wgZP1tAjPAqVcU3P6Wbvs_FCb'
      }).then((response) => {
  ...
  editState(task, checked){
      axios.request({
          method:'put',
          url:'https://api.mlab.com/api/1/databases/reacttasksapp/collections/tasks/'+task._id.$oid+'?apiKey=hGZCvC3wgZP1tAjPAqVcU3P6Wbvs_FCb',
          data: {
              text: task.text,
              completed: checked
          }
  ...
  clearTasks(){
      ...
      while(i--){
          if(tasks[i].completed === true){
              ...
              axios.request({
                  method: 'delete',
                  url:'https://api.mlab.com/api/1/databases/reacttasksapp/collections/tasks/'+id+'?apiKey=hGZCvC3wgZP1tAjPAqVcU3P6Wbvs_FCb'
              }).then((response) => {
